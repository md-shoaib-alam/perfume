...
export const OrdersTab: React.FC<OrdersTabProps> = ({
  ...
  return (
    <div className="space-y-4">
      ...
      {orders.length === 0 ? (
        <div className="bg-white rounded-2xl p-10 border border-slate-100 text-center text-slate-400 shadow-2xs">
          ...
          {orders.map((ord, i) => {
            ...
            return (
              <div
                ...
                className="bg-white p-4 sm:p-5 rounded-2xl border border-slate-100 shadow-2xs hover:border-[#caa04c]/60 hover:shadow-xs transition-all cursor-pointer flex items-center justify-between gap-4 group"
              >
                {/* Left: Box Icon in rounded container + Order Number & Date */}
                <div className="flex items-center gap-3.5 min-w-0">
                  <div className="w-10 h-10 rounded-xl bg-slate-50 border border-slate-100 flex items-center justify-center text-[#d09e44] shrink-0 group-hover:bg-amber-50/60 group-hover:border-amber-200/50 transition-colors">
                ...
                <div className="flex items-center gap-3 sm:gap-4 shrink-0">
                  ...
                  <span className={`px-3 py-1 text-[10px] sm:text-[11px] font-bold rounded-full uppercase tracking-wider ${
                    rawStatus === 'delivered'
                  ...
                  <span className="text-slate-400 group-hover:text-[#caa04c] transition-colors">
