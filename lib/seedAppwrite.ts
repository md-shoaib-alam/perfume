...
const DEFAULT_SETTINGS = {
  ...
  heritageTitleHighlight: 'ROYAL HERITAGE & ARABIAN FINESSE',
  heritageNarrative: 'BakhoorBliss brings together centuries of Royal Attar and Bakhoor traditions with modern haute perfumery. Every fragrance is macerated for 90 days in dark oak barrels to achieve unprecedented longevity and depth.',
