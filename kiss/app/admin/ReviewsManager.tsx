  ...
  return (
    <div className="space-y-6 font-sans">
      ...
      <div className="space-y-4">
        {reviews.map((rev) => (
          <div key={rev.id} className="bg-white p-5 rounded-xl border border-slate-200 shadow-xs flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            <div className="flex items-center gap-2 shrink-0">
              ...
              <button
                ...
                className="px-3 py-1.5 bg-red-50 hover:bg-red-100 text-red-700 rounded text-xs font-semibold"
              >
                Remove
              </button>
            </div>
