import type { Product, Review } from '@/app/types';

/**
 * Server-only seed fixture for initial Appwrite database population.
 * 
 * IMPORTANT:
 * This file is for administrative database seeding only.
 * Storefront components and pages MUST NOT import this data.
 * All storefront catalog items, reviews, and media must be dynamically
 * fetched from Appwrite Database (`perfumedb`) and Storage (`perfume_media`).
 */

export const INITIAL_SEED_PRODUCTS: Partial<Product>[] = [
  {
    name: 'Haute Vetiver',
  ...
  {
    name: 'Portable Travel Atomizer Set',
    subtitle: 'Customizable Luxury Atomizers • 3x10ml Pocket Travel Sprays',
    category: 'travel-set',
    gender: 'Gift Sets',
    price: 2499,
    originalPrice: 3200,
    rating: 4.9,
    reviewsCount: 195,
    volume: '3 x 10ml (30ml Total)',
    image: 'https://images.unsplash.com/photo-1541643600914-78b084683601?auto=format&fit=crop&w=800&q=80',
    hoverImage: 'https://images.unsplash.com/photo-1541643600914-78b084683601?auto=format&fit=crop&w=800&q=80',
    isBestseller: true,
    tagline: 'BUILD YOUR PORTABLE TRAVEL SET',
    badgeText: 'CUSTOMIZABLE ATOMIZERS',
    badgeSubtext: 'Gold-Embossed Case',
    notes: {
      top: ['Custom Selection', 'Pocket-Sized Atomizers'],
      heart: ['Leak-Proof Design', 'Flight Carry-On Approved'],
      base: ['Gold-Embossed Travel Vault']
    },
    description: 'Choose any 3 or 5 pocket-sized 10ml travel spray atomizers in gold-embossed cases. Perfect for flight carry-ons, evening galas, and on-the-go touchups.',
    sizeOptions: [
      { size: '3 x 10ml Box', price: 2499, originalPrice: 3200, isSoldOut: false },
      { size: '5 x 10ml Box', price: 3999, originalPrice: 4990, isSoldOut: false }
    ]
  }
];

export const INITIAL_SEED_REVIEWS: Partial<Review>[] = [
  {
